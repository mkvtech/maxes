...
class GraphGenerator2:
    ...
    def fit(self, xes: XesFile) -> GraphGenerator2:
        self.sequences_ = []
        ...
        self.tree_ = src.xes.analyze_sequence.traverse_all_pathes(
    ...
    def generate(self) -> list[str]:
        return src.xes.analyze_sequence.random_weighted_tree_path(
